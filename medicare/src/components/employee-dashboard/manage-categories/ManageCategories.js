    ...
    return (
      <div>
        <div className="row mb-3">
          ...
          <span className="float-right ml-auto mr-5 pointer"  data-toggle="collapse" data-target={'#'+1}>
            <i className="material-icons">playlist_add</i> Add
          </span>
        </div>
        <ul className="list-group">
        <li id={"1"} className="list-group-item list-group-item-action collapse justify-content-between mt-1">
              <form>
